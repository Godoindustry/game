...
export const ITEMS: ItemDef[] = [
  ...
  d({ id: "cracha_iara", name: "Crachá de Iara Menezes", description: "Plastificado, dentro de uma bolsa estanque laranja. Ficou 28 anos no fundo do poço.", category: "documento", weightG: 20, volumeMl: 15, properties: { readable: "IARA MENEZES — HIDROLOGIA — 1998. No verso, a caneta: “Se alguém achar isto: 074 não é frequência. É o rumo deles. Eles pousam às 23h40.”" } }),
